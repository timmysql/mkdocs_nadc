...
class BuildAFiler:
    ...
    def build_rcp_tags(self) -> str:
        ...
        if self.org_id in [7566,7319,7325,7369,7579,7339\
                            ,7586,7321,7345,7347,7591,7356\
                            ,7411,7357,7360,8036,7365,7620\
                            ,7370,7374,7669,7380,7645,7394\
                            ,7404,7405,7909,7409,7413,7431\
                            ,8090,8037,8325,7649,7668,7456\
                            ,7458,7461,7473,7476,7675,8007\
                            ,7513,7520,7541,7627,7640,7548,7699]:
            tag_body = '  - Current Unicam - Receipts\n'
